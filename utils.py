...
def parse_args():
    ...
    parser.add_argument('--lr', type=float, default=0.1, help='start learning rate. make sure the lr for ArcMarginModel is less (i.e. around 0.01). use two lr for each modules.')
    ...
    parser.add_argument('--margin-s', type=float, default=30.0, help='feature scale s. for vanilla architectures, use 30.0')
